...
export default component$(() => {
  ...
  return (
    <nav class='ml-auto mr-[80px] flex flex-row flex-nowrap md:mr-[60px] 2xl:mr-[20px]'>
      <button
        class='-ml-0.5 mr-2 inline-flex items-center justify-center gap-2 rounded-md p-2 text-base font-medium text-white focus-visible:outline focus-visible:outline-offset-0 active:text-white disabled:right-0 disabled:cursor-not-allowed disabled:bg-transparent disabled:shadow-none'
        data-testid='button'
      ...
      >
        <div class='relative inline-flex rounded-full bg-inherit'>
          ...
          <div class='pointer-events-none absolute right-0 top-0 -translate-y-1/2 translate-x-1/2 rounded-[inherit] bg-inherit p-0.5'>
            <div class='min-w-[0.75rem] rounded-[inherit] bg-white px-1 text-center text-xs font-medium text-neutral-900'>
